...
function View_Customers() {
  ...
  const filteredCustomers = customer.filter((customerItem) => {
    ...
    const matchesGender =
      selectedGender === "All" || customerItem.gender === selectedGender;
    ...
    const validationRequest = async () => {
      try {
        const response = await axios.get(
          "https://localhost:7017/Users/getCustomers"
        );
  ...
  const handleValidation = async (
    ...
    try {
      const response = await axios.put(
        `https://localhost:7017/Users/validateCustomer/${customerId}`,
  ...
  const handleUpdatePassword = async (customerId) => {
    ...
    if (newPassword === confirmPassword) {
      try {
        const response = await axios.put(
          `https://localhost:7017/Users/updateCustomerPassword/${customerId}`,
  ...
  // NEW CODE
  return (
    <div className="view-customers-main-container">
      <div className="view-supp-header">
        <div className="filter-customers-container">
          ...
          <div className="customer-status-filter-container">
            ...
            <label className="customerStatus-label" htmlFor="status">
              Status:
            </label>
            <select
          ...
          <div className="gender-filter-container">
            <label className="customerGender-label" htmlFor="status">
              Gender:
            </label>
            <select
              style={{ padding: "10px", border: "2px solid white" }}
          ...
          <div className="department-filter-container">
            <label className="customerDepartment-label" htmlFor="status">
              Department:
            </label>
            <select
              style={{ padding: "10px", border: "2px solid white" }}
            ...
            {filteredCustomers.map((customerItem) => (
              <tr key={customerItem.id}>
                <th
                  ...
                  onClick={() => setSelectedCustomer(customerItem)}
                >
                  {customerItem.id}
                </th>
                <td
                ...
                <td
                  ...
                  onClick={() => setSelectedCustomer(customerItem)}
                >
                  {getDepartmentName(customerItem.departmentId)}
                </td>
                <td
                  className="text-center"
                  data-bs-toggle="modal"
                ...
                <td
                  ...
                  onClick={() => setSelectedCustomer(customerItem)}
                >
                  {customerItem.isActive ? "Active" : "Not Active"}
                </td>
                <td className="text-center">
                  <button
                    className={`validation-btn-supp btn btn-sm ${
                      customerItem.isValidate ? "btn-success" : "btn-danger"
                    }`}
                    onClick={() =>
                      handleValidation(
                        customerItem.id,
                        customerItem.isValidate,
                        customerItem.isActive
                      )
                    }
                  >
                    <img
                      className="validation-icon"
                      src={customerItem.isValidate ? validIcon : invalidIcon}
                    />
        ...
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content">
            ...
            <div className="modal-body">
              {selectedCustomer && (
                <div className="supplier-profile-container">
                  <img
                    ...
                    src={`https://localhost:7017/${selectedCustomer.image}`}
                  ...
                  <div className="supplier-text-info">
                    ...
                    <div className="supplier-info-container">
                      ...
                      <div className="supplier-text-2">
                        ...
                        <h5 className="info-2-supp">
                          {getDepartmentName(selectedCustomer.departmentId)}
                        </h5>
                        <h5 className="info-2-supp">
              ...
              <button
                className="col-md-12 edit-customer-btn"
                type="button"
                data-bs-toggle="collapse"
                  ...
                  <div className="card card-body">
                    ...
                    <div className="saveChanges-btn-container">
                      <button
                        ...
                        onClick={() =>
                          handleUpdatePassword(selectedCustomer.id)
                        }
                      >
                        Save Changes
                      </button>
