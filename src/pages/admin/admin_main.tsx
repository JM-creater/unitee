                ...
                <div className="admin-main-container">
                    ...
                    <div style={{ minHeight:'100%' }}>
                        <div className="admin-second-nav-container">
                            ...
                            <div>
                                <div>
                                    <button className="admin-logout-btn" data-bs-toggle="modal" data-bs-target="#logoutModal" onClick={() => setShowLogoutModal(true)}>
                                ...
                                {showLogoutModal && (
                                    <div className="modal fade" id="logoutModal" tabIndex={1} aria-labelledby="logoutModalLabel" aria-hidden="false">
                                        <div className="modal-dialog modal-dialog-centered">
                                            <div className="modal-content">
                                                <div className="logout-confirmation-modalBody">
                                                    <h3>Are you sure you want to logout?</h3>
                                                    <div className="col-md-12 logout-btn-container">
                                                        <button className="logout-btn" data-bs-dismiss="modal" onClick={HandleLogout}>Log Out</button>
                                                        <button className="cancel-logout-btn" data-bs-dismiss="modal" onClick={() => setShowLogoutModal(false)}>Cancel</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
