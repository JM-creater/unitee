...
function Search_Product() {
  ...
  const addToCart = () => {
    ...
    axios
      .post("https://localhost:7017/Cart/add", cartAddRequest)
      .then(() => {
        ...
        {isLoading ? (
            ...
            <div className="sub-container">
                ...
                {filteredProduct.map((product) => (
                    ...
                    data-bs-target={
                        !product.isActive ? undefined : "#viewProdDetailsModal"
                    }
                    ...
                    <div className="modal-body viewProd-modalBody">
                        ...
                        <React.Fragment>
                            ...
                            <div className="hover-container">
                                ...
                                onMouseOver={() =>
                                    setNotHover(
                                    `https://localhost:7017/${selectedProduct.frontViewImage}`
                                    )
                                }
                                ...
                                onMouseOver={() =>
                                    setNotHover(
                                    `https://localhost:7017/${selectedProduct.sideViewImage}`
                                    )
                                }
                                onMouseLeave={() => setNotHover("")}
                                >
                                ...
                                onMouseOver={() =>
                                    setNotHover(
                                    `https://localhost:7017/${selectedProduct.backViewImage}`
                                    )
                                }
                                onMouseLeave={() => setNotHover("")}
                                >
                            ...
                            <h5 className="prodModal-text">
                                {getDepartmentName(
                                selectedProduct.productDepartments.departmentId
                                )}
                            </h5>
                            <h5 className="prodModal-text">
                            ...
                            <div className="prodModal-quantity-container">
                                ...
                                <button
                                className="prodModal-minus-quanti-btn"
                                ...
                                <button
                                className="prodModal-plus-quanti-btn"
